<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/treasury/cheque_status/profile/&id={t_id}">
                <span class="icon" id="treasury_profile"></span>
                <span class="label {profile.class}">Profile</span>                
            </a>            
        </li>     
        
         <li>
            <a href="/treasury/cheque_status/remarks/&id={t_id}">
                <span class="icon" id="treasury_remarks"></span>
