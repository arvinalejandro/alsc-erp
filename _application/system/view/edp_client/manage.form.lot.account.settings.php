<table class="mar_custom _form display_none" id="_lot_account_settings_" style="font-weight:normal;" width="70%" cellpadding="8" cellspacing="0" border="0">
    ...
    <tr>
        <td colspan="4" class="bg_fff">
            <div class="mar_custom" style="margin-top:10px; width:306px;">
                <a class="link_button_inline float_left blue" style="border-radius:3px 0 0 3px; width:80px;" onclick="next_form('lot_profile')">Back</a>
                <a class="link_button_inline float_left gray" style="border-radius:0; width:80px;" href="/edp_client">Cancel</a>
                <a class="link_button_inline float_left blue" style="border-radius:0 3px 3px 0; width:80px;" onclick="next_form('lot_account_computation')">Next</a>
