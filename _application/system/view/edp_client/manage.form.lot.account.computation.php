<table class="mar_custom _form display_none" id="_lot_account_computation_" style="font-weight:normal;" width="70%" cellpadding="8" cellspacing="0" border="0">
    <thead><tr><td colspan="4"><h1>Account Overview</h1></td></tr></thead>
    <tr>        			
        <td><b>Account Number: s</b></td>
        				
        <td colspan="3">
        	<input type="text" name="client_account[str][client_account_number]" class="client_account_number__"   />
        </td>  		
        	
    </tr>
    <tr>        			
        <td><b>Project: </b></td>
        <td class="__project_name"><span >s</span></td>
        <td><b>Phase: </b></td>        			
        <td><span class="__project_site_name"></span></td>        			
    </tr>
    <tr>        			
        <td><b>Block: </b></td>
        <td><span class="__project_site_block_name"></span></td>
        <td><b>Lot : </b></td>        			
        <td><span class="__lot_name"></span> <input type="hidden" name="client_account[int][lot_id]" value="" class="lot_id__"  /></td>        			
    </tr>
    <tr>        			
        <td><b>Type: </b></td>
        <td><span class="__option_unit_name"></span></td>
    ...
    <tr>        			
        ...
        <td width="20%"><span class="__lot_area"></span> sqm.</td>
        <td width="15%"></td>
        <td width="20%"></td>
    </tr>
    <tr>        			
        <td><b>Price/sqm. : </b> </td>
        <td>P <span class="___lot_price"></span> / sqm.</td>
        <td></td>
        <td></td>
    </tr> 
    <tr>        			
        <td><b>LCP: </b> </td>
        <td>
        	P <span class="___lcp"></span> 
        	<input type="hidden" name="client_account[int][client_account_lcp]" value="" class="lcp__"  id="client_account_lcp"  />
        </td>
        <td></td>        			
        <td></td>        			
    </tr> 
    ...
    <tr>
        ...
        <td><b>Net LCP: </b> </td>
        <td>
        	P <span class="_client_account_lcp_net ___lcp" ></span> 
        	<input type="hidden" name="client_account[int][client_account_lcp_net]" value="" class="lcp__" id="client_account_lcp_net" />
        </td>
    </tr>       		
    <thead><tr><td colspan="4"><h1>Investment Value - House</h1></td></tr></thead>      		
    <tr class="">        			
        <td><b>House Model : </b></td>
        <td><span class="__house_name"></span></td>
        <td><b>Classification : </b> </td>
        <td><span class="__option_house_classification_name"></span></td>
    </tr>     
    <tr class="">        			
        <td><b>Unit Status : </b> </td>
        <td><span class="__option_availability_name"></span></td>
        <td><b>Floor Area : </b> </td>
        <td><span class="__house_area"></span></td>        			
    </tr>     
    <tr> 
        <td><b>House Price : </b></td>
        <td><input type="text"  name="client_account[int][client_account_hcp]" id="client_account_hcp" class="_compute_ house_price__" /></td>
        <td></td>
        <td></td>
    </tr>             		        		
    ...
    <tr>
    	...
    	<td></td>
    	<td><b>Net LCP: </b></td>
    	<td>P <span class="_client_account_lcp_net ___lcp"></span></td>
    </tr>
    <tr>
    	<td></td>
    	<td></td>
    	<td><b>HCP: </b></td>
    	<td>P <span class="_client_account_hcp ___house_price"></span></td>
    </tr>
    <tr>
    ...
    <tr>
    	...
    	<td><b>Net TCP:</b> </td>
    	<td>
        	<b class="color_green">P<span class="_client_account_tcp_net ___tcp"></span></b>
        	<input type="hidden" name="client_account[int][client_account_tcp_net]" value="" class="tcp__" id="client_account_tcp_net" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td><b>Net TCP: </b></td>
        <td>P <span class="_client_account_tcp_net ___tcp"></span></td>
    </tr>
    <tr>        			
    ...
    <tr>        		
        ...
        <td class="color_green">
        	<b>P</b> <b class="_client_account_ma_amount ___tcp"></b>
        	<input type="hidden" name="client_account_structure[int][client_account_ma_amount]" class="_tcp__" id="client_account_ma_amount" />
        </td>        
    </tr>
    ...
    <tr>
        <td colspan="4" class="bg_fff">
            <div class="mar_custom" style="margin-top:10px; width:306px;">
                <a class="link_button_inline float_left blue" style="border-radius:3px 0 0 3px; width:80px;" onclick="next_form('lot_account_settings')">Back</a>
