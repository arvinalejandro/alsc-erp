...
<div id="content_body">     
    ...
    <div id="side_listings" >
        ...
        <div style="overflow: auto;" id="_right_content_">  <!--set max-height by making it dynamic -->       	
        	<br/>        	
        	<form action="/edp_client/edp_client_manage/account_add_house_submit/&id=<?=$_GET['id']?>" name="alsc_form" method="post">
        		...
        		<input type="hidden" name="client_account[str][client_account_type]" value="House Only" />
        		...
        		<table class="mar_custom _form " id="_account_" style="font-weight:normal;" width="70%" cellpadding="8" cellspacing="0" border="0">
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Account Settings</h1></td></tr>
        			<tr>        			
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Account Overview</h1></td></tr>
        			<tr>        			
        			...
        			<tr>        			
        				<td><b>Unit Type: </b></td>
        				<td><span>House Only</span></td>
        				<td><b>Date of Sale: </td>        			
        				<td><input type="text" name="client_account[str][client_account_date_sale]" class="_date_" /></td>    			
        			</tr>
        			
        			<tr class="display_none" style="background-color: #555; color: #fff;"><td colspan="4"><h1>Investment Value - Lot</h1></td></tr>        		
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Investment Value - House</h1></td></tr>         		
        			<tr>        			
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Investment Computation</h1></td></tr>
        			<tr>        			
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Down Payment Schedule</h1></td></tr>
        			<tr>        			
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Monthly Amortization</h1></td></tr>
        			<tr>        			
        				<td><b>Net TCP: </b></td>
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Marketing</h1></td></tr>
                    <tr>                    
                        <td><b>Network: </b></td>
        			...
        			<tr style="background-color: #555; color: #fff;"><td colspan="4"><h1>Remarks</h1></td></tr>
        			<tr>
        				<td>Remarks</td>
        				<td colspan="3">
        			...
        			<tr>
        				<td colspan="4">
        					<div class="align_center" style="margin-top:10px;">				               
				                <a class="link_button_inline blue" href="/edp_client/edp_client_manage/account_add_house/&id=<?=$_GET['id']?>">Back</a>
