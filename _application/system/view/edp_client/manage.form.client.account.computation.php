<table class="mar_custom _form display_none" id="_account_" style="font-weight:normal;" width="70%" cellpadding="8" cellspacing="0" border="0">
    ...
    <tr>        			
        ...
        <td colspan="3">
        	<span class="color_green">{client_account_number}</span>
        	<input type="hidden" name="client_account[str][client_account_number]" value="{client_account_number}"   />
        </td>  		
    ...
    <tr>        			
        ...
        <td><b>Lot : </b></td>        			
        <td><span>{lot_name}</span> <input type="hidden" name="client_account[int][lot_id]" value="{lot_id}"  /></td>        			
    </tr>
    <tr>        			
        <td><b>Type: </b></td>
    ...
    <tr>        			
        ...
        <td>
        	P <span>{_lcp}</span> 
        	<input type="hidden" name="client_account[int][client_account_lcp]" value="{lcp}"  id="client_account_lcp"  />
        </td>
        <td></td>        			
        <td></td>        			
    </tr> 
    ...
    <tr>
        ...
        <td><b>Net LCP: </b> </td>
        <td>
        	P <span class="_client_account_lcp_net">{_lcp}</span> 
        	<input type="hidden" name="client_account[int][client_account_lcp_net]" value="{lcp}" id="client_account_lcp_net" />
        </td>
    </tr>       		
    <thead class="<?=$disable_house?>"><tr><td colspan="4"><h1>Investment Value - House</h1></td></tr></thead>      		
    <tr class="<?=$disable_house?>">        			
        <td><b>House Model : </b></td>
        <td><span>{house_name}</span></td>
        <td><b>Classification : </b> </td>
        <td><span>{option_house_classification_name}</span></td>
    </tr>     
    <tr class="<?=$disable_house?>">        			
    ...
    <tr> 
        ...
        <td><input type="text" value="{house_price}" name="client_account[int][client_account_hcp]" id="client_account_hcp" class="_compute_" /></td>
        <td></td>
        <td></td>
    </tr>             		        		
    ...
    <tr>
    	...
    	<td>
        	...
        	<input type="hidden" name="client_account[int][client_account_tcp_net]" value="{tcp}" id="client_account_tcp_net" />
        </td>
    </tr>
