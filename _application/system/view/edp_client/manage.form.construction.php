...
<div id="content_body">    
    ...
    <div id="side_listings" > 
        ...
        <div class="border_bottom_gray" id="controls">
		    <div class="content_block_vpad align_center">			        
			    <div class="mar_custom" style="width:710px;">
                    <a class="link_button_inline float_left _control blue" id="_construction_list" style="border-radius:3px 0 0 3px;">
                        <span style="border: 1px solid #919296; border-radius:10px; padding:2px 6px; background-color:#fff; color:#919296;">1</span>
                        Engineering Projects
                    </a>       
                    <a class="link_button_inline float_left _control gray" id="_construction_profile" style="border-radius:3px 0 0 3px;">
                        <span style="border: 1px solid #919296; border-radius:10px; padding:2px 6px; background-color:#fff; color:#919296;">1</span>
                        Project Profile
                    </a>                               
                    <a class="link_button_inline float_left _control gray" id="_construction_account_settings" style="border-radius:0;">
                        <span style="border: 1px solid #919296; border-radius:10px; padding:2px 6px; background-color:#fff; color:#919296;">4</span>
                        Account Settings
                    </a>
                    <a class="link_button_inline float_left _control gray" id="_construction_computation" style="border-radius:0;">
        ...
        <div style="overflow: auto;" id="_right_content_">  <!--set max-height by making it dynamic -->       	
        	<br/>        	
        	<form action="/edp_client/edp_client_manage/account_submit" name="alsc_form" method="post">             		       		
        		<!-- investment -->
        		<?=$_VIEW['view']['construction.list']?>    
        			        			 		        		
        		<!-- client -->
        		<?=$_VIEW['view']['construction.profile']?>       		  
        			<input type="hidden" name="client[int][user_id]" value="<?=$_VIEW['user_id']?>" />      
        		<!-- reservation -->
        		<?=$_VIEW['view']['construction.account.settings']?>
        		<!-- account_settings -->
        		<?=$_VIEW['view']['construction.computation']?>
        		<!-- account -->        			  		      		
        			...
        			<input type="hidden" name="client_account_construction[int][lot_construction_id]"  class="lot_construction_id__" />
        			<input type="hidden" name="client_id" value="<?=$_VIEW['client_id']?>" />
