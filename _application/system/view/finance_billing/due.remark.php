    ...
    <div id="side_listings" style="margin-left:180px;">
    	...
    	<div class="mar_custom" style="border:10px solid #eaeaea; border-bottom:10px solid #eaeaea; border-top:0; padding-bottom: 5px;" id="controls">
            ...
            <b class="font_size_18">
                 <?=$_VIEW['client_account_number']?> : <?=$_VIEW['client_surname']?>, <?=$_VIEW['client_name']?>
            </b>
                ...
                <tr class="selected <?=$_VIEW['module_empty']?>">
                    <td>
                        <div style="width:90%; margin:0 auto;">
                            <form name="alsc_form" method="post" action="/finance_billing/due/submit_remark">
                                <textarea style="width: 100%; height: 80px;" name="textarea[remark_content]" id="remark_form"></textarea>
                                <input type="hidden" name="str[remark_key]" value="client_account" />
                                <input type="hidden" name="int[remark_key_id]" value="<?=$_VIEW['client_account_id']?>" />
