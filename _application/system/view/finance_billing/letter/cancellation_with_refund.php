...
<html>
	...
	<div style="display: none;">
        <form action="/finance_billing/due/letter_submit" method="POST" name="alsc_form">
            ...
            <input name="str[account_letter_name]" value="CANCELLATION LETTER WITH REFUND" />
        </form>
    </div>
	...
	<div>
        <div id="print_controls" class="display_none">
            <div style="float:left; margin-left:20px;">
                <h3>File Name:</h3>
                <h2>Cancellation Letter With Refund</h2>
            </div>
        ...
        <div id="content">
            ...
            <div style="margin:0 auto;">
                ...
                <div id="document">CANCELLATION LETTER WITH REFUND</div>
                ...
                <p>
                    ...
                    <b class="output_detail">Account Restructuring</b>
                </p>
                <p>
                    ...
                    is hereby cancelled and terminated and part of your payments make per your
                    <b class="output_detail">Account Restructuring</b> is hereby waived in favor of the Corporation as rental payment for the said property. However, your cash surrender value shall be available for pick-up at the office upon your advice. If you need further clarification on this matter, please do not hesitate to visit or call us at (044) 791-2508 to 09 and look for MS. JULIE C. MARA?ON.   
                </p>
                ...
                <p>
                    BEFORE ME, a Notary Public for and in MALOLOS BULACAN on
                    ________________,
                    personally appeared CELINE ANGELICA B. GONZALES with Unified Multi-Purpose ID No. CRN-0111-0665913-4, personally known to me to the same person who executed the foregoing instrument and acknowledged to me that the same is of her own free act and deed.
                    <label></label>
                </p> 
                ...
                <div id="input_body">
                    <table width="100%" cellpadding="10" cellspacing="0" border="0" class="border">
                        ...
                        <tr>
                            <td>
                                <span>Detail</span>
                                <input type="text" value="Account Restructuring" id="input_detail" onkeyup="type_detail()" />
                            </td>
                            <td>
                                <span>ALSC Address</span>
                                <input type="text" value="Woodlands of Grand Royale" id="input_alsc" onkeyup="type_alsc()" />
                            </td>
                        </tr>
                        <tr>
                            <td>
