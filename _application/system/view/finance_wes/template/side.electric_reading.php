<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/finance_wes/electric_reading/profile/&id={lot_wes_reading_id}">
        ...
        <li>
            <a href="/finance_wes/electric_reading/remark/&id={lot_wes_reading_id}">
        ...
        <li>
            ...
            <a href="/finance_wes/electric_reading/payment/&id={lot_wes_reading_id}">
                <span class="icon" id="edp_edit"></span>
                <span class="label color_red {payment.class}">Payment</span>
            </a>
            
            <a href="/finance_wes/electric_reading/payment_status/&id={lot_wes_reading_id}">
                <span class="icon" id="edp_edit"></span>
