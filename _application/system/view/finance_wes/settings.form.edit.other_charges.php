<div id="content_body">    
    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/finance_wes/settings/submit_edit_other_charge/" method="post" name="alsc_form">
                <input type="hidden" name="id" value="<?=$_VIEW['option_wes_charge_id']?>">
	            <table width="70%" cellpadding="10" cellspacing="0" border="0" style="font-weight:normal; margin-top: 20px;" align="center">                    
                    ...
                    <tr>
                        ...
                        <td>
                        	<input  type="text"  name="other_charge[str][option_wes_charge_name]" value="<?=$_VIEW['option_wes_charge_name']?>">                      
                        </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td>
                        	<input  type="text" name="other_charge[int][option_wes_charge_amount]" value="<?=string_amount($_VIEW['option_wes_charge_amount'])?>">                      
                        </td>
                    </tr>
