   ...
   <?=$_VIEW['side_nav']?>
    ...
    <div id="side_listings" style="margin-left:180px;">     
        ...
        <div style="overflow: auto;" id="_right_content_">  <!--set max-height by making it dynamic -->       	
        		...
        		<form action="/finance_cashier/reservation/submit_reservation" name="alsc_form" method="post">
        		<input type="hidden" name="client_account_id" value="0" />
        		...
        		<input type="hidden" name="account_receive[str][option_income_type_id]"  value="reservation" />
        		...
        		<table class="mar_custom" id="_account_" style="font-weight:normal;" width="90%" cellpadding="5" cellspacing="0" border="0">      			
        			...
        			<tr>
        				<td><b>Payee : </b></td>
        				<td colspan="3">
        					<input type="text" name="account_receive[str][account_receive_payee]" />
        				</td>
        			</tr>  
        			<tr>
        				<td><b>Address : </b></td>
        				<td colspan="3">
        					<input type="text" name="account_receive[str][account_receive_address]" />
        				</td>
        			</tr>    
        			<tr>
        				<td><b>Remarks : </b></td>
