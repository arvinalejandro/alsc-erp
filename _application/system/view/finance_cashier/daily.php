    ...
    <div id="side_listings" style="margin-left:0px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
            <table class="mar_custom" style="font-weight:normal; margin-top:20px;" width="70%" cellpadding="5" cellspacing="0" border="0">
                    <thead>
                    	<tr>                    		
                    		<td colspan="4">Report Name</td>                    		                   		              		                   		   		
                    	</tr>
                    </thead>
                    <tbody>
                    	<tr>                    		
                    		<td><b>Daily Report - OR</b></td>
                            <td width="200"><a class="link_button_block gray" href="/report_generator">Generate</a></td>          		                 		        		
                    	</tr> 
                    	<tr>                    		
                    		<td><b>Daily Report - CR</b></td>
                            <td width="200"><a class="link_button_block gray" href="/report_generator">Generate</a></td>          		                 		        		
                    	</tr> 
                    	<tr>                    		
                    		<td><b>Daily Report - CAR</b></td>
                            <td width="200"><a class="link_button_block gray" href="/report_generator">Generate</a></td>          		                 		        		
                    	</tr> 
                        <tr>                            
                            <td><b>Summary of All Receipt Types</b></td>
                            <td width="200"><a class="link_button_block gray" href="/report_generator">Generate</a></td>                                                           
                        </tr>                     	            	              	
                    </tbody>             
