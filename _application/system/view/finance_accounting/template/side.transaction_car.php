<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/finance_accounting/transaction_car/profile">
                <span class="icon" id="finance_accounting_profile"></span>
                <span class="label {profile.class}">Profile</span>                
            </a>    
            <a href="/finance_accounting/transaction_car/breakdown">
                <span class="icon" id="finance_accounting_breakdown"></span>
                <span class="label {invoice.class}">Breakdown</span>                
            </a>     
            <a href="/finance_accounting/transaction_car/remark">
                <span class="icon" id="finance_accounting_remarks"></span>
