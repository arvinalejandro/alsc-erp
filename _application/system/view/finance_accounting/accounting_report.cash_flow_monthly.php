    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div class="mar_custom" style="border:10px solid #eaeaea; border-bottom:10px solid #eaeaea; border-top:0; padding-bottom: 5px;" id="controls">
            ...
            <div class="float_left" style="width: 50%;">                
                <b class="font_size_18">Monthly Cash Flow</b>            
            </div>
            
            <a href="#" class="float_right link_button_inline blue font_size_14">January 2015</a>
            <a href="#" class="float_right link_button_inline blue font_size_14" style="margin-right:10px;" onclick="open_form()">Print</a>
            <label></label>
        </div> 
        <div style="overflow: auto;" id="_right_content_">
            
            <table class="mar_standard" width="50%" cellpadding="3" cellspacing="0" border="0">
                <thead>
                    <tr align="right">                          
                        <td></td>
                        <td>Amount</td>
                ...
                <tbody align="right"> 
                    <tr><td colspan="2" align="left">SOURCES OF CASH</td></tr>
                    <tr><td align="left" colspan="2"><div class="details" style="margin-left: 10px;">SALES</div></td></tr>
                    <tr>
                    ...
                    <tr><td align="left" colspan="2"><div class="details" style="margin-left: 10px;">OTHER CASH INPUTS</div></td></tr> 
                    <tr>
                    ...
                    <tr><td align="left" colspan="2">USES OF CASH</td></tr> 
                    <tr><td align="left" colspan="2"><div class="details" style="margin-left: 10px;">DEVELOPMENT COSTS</div></td></tr>
                    <tr>
            ...
            <script type="text/javascript">
                function open_form()
                {
                var myWindow = window.open("http://alsc/finance_accounting/accounting_report_form/cash_flow_monthly", "_blank", "width=1000, height=600, toolbar=no, scrollbars=yes, resizable=no, resizable=yes, top=50, left=50, location=no");
                }    
            </script>
