    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div class="mar_custom" style="border:10px solid #eaeaea; border-bottom:10px solid #eaeaea; border-top:0; padding-bottom: 5px;" id="controls">
            ...
            <div class="float_left" style="width: 50%;">                
                <b class="font_size_18">Annual Cash Flow</b>            
            </div>
            
            <a href="#" class="float_right link_button_inline blue font_size_14">Year 2014</a>
            <a href="#" class="float_right link_button_inline blue font_size_14" style="margin-right:10px;" onclick="open_form()">Print</a>
            <label></label>
        </div> 
        <div style="overflow: auto;" id="_right_content_">
            
            <table class="mar_custom" width="140%" cellpadding="3" cellspacing="0" border="0" style="padding:20px 20px 80px 20px;">
                <thead>
                    <tr align="right">                          
                        <td></td>
                        <td>January</td>
            ...
            <script type="text/javascript">
                function open_form()
                {
                    var myWindow = window.open("http://alsc/finance_accounting/accounting_report_form/cash_flow_yearly", "_blank", "width=1000, height=600, toolbar=no, scrollbars=yes, resizable=no, resizable=yes, top=50, left=50, location=no");
                }    
            </script>
        </div>    
    </div>
