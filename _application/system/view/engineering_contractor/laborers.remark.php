                ...
                <tr class="selected">
                    <td>
                        <div style="width:90%; margin:0 auto;">
                            <form name="alsc_form" method="post" action="/engineering_contractor/laborers/submit_remark">
                                <textarea style="width: 100%; height: 80px;" name="textarea[remark_content]" id="remark_form"></textarea>
                                <input type="hidden" name="str[remark_key]" value="contractor_laborer" />
                                <input type="hidden" name="int[remark_key_id]" value="<?=$_VIEW['contractor_laborer_id']?>" />                              
                                <input type="hidden" name="contractor_laborer_id" value="<?=$_VIEW['contractor_laborer_id']?>" />                              
                            </form>
