<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/finance_disbursement/ofv/profile/&id={t_id}">
                <span class="icon" id="liquidate_profile"></span>
                <span class="label {profile.class}">Profile</span>                
            </a>            
        </li>     
        
         <li>
            <a href="/finance_disbursement/ofv/remarks/&id={t_id}">
                <span class="icon" id="liquidate_remarks"></span>
