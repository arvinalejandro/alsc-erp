    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/engineering/lot/submit_package" method="post" name="alsc_form">
           		...
           		<input type="hidden" name="req_type" value="house" />              		
	            ...
	            <table width="70%" cellpadding="10" cellspacing="0" border="0" style="font-weight:normal; margin-top:20px;" align="center">
                    ...
                    <tr>
                        ...
                        <td>
							<input type="text" value="<?=$_VIEW['esitmated_cost']?>" name="lot_construction[int][lot_construction_cost_estimate]" style="width: 90%;">
                        </td>
                    </tr>
	                ...
	                <tr valign="middle">
	                   <td colspan="4" align="center">                  		
                       		<div class="content_block_vpad">                       				
                       			...
                       			?>
                       			<a href="/engineering/lot/profile/&id=<?=$_GET['id']?>" class="link_button_inline red">Cancel</a>
