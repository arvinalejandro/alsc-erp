        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/engineering/construction/update_status/&id=<?=$_VIEW['lot_construction_id']?>" method="post" name="alsc_form">
	            ...
	            <table width="70%" cellpadding="10" cellspacing="0" border="0" style="font-weight:normal; margin-top: 20px;" align="center">                    
                    <thead>
                        <tr>
                            <td colspan="4">Change Construction Status</td>
                        </tr>
                    </thead>        
                    <tr>
                     
                        <td class="color_gray">Construction Type:</td>
                        <td><?=$_VIEW['option_unit_construction_name']?></td>
                    ...
                    <tr>
                        <td class="color_gray">Date Started:</td>
                        <td>
                        ...
                        <td class="color_gray">Date Completed:</td>
                        <td>
