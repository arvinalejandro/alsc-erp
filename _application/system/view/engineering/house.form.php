<div id="content_body">    
    ...
    <div id="side_listings" style="margin-left:0px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/engineering/house_inventory/submit" method="post" name="alsc_form">
	                    ...
	                    <tr valign="middle">
	                       <td colspan="4" align="center">                  		
                       			<div class="content_block_vpad">                       				
                       				<?php
                       					$id		=	$_VIEW['house_id'] * 1;
                       					$link	=	($id) ? "/engineering/house_inventory/profile/&id={$id}" : '/engineering/house_inventory';
