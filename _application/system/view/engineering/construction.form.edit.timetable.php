<div id="content_body">    
    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/engineering/construction/submit_edit_timetable/" method="post" name="alsc_form">
           		<input type="hidden" value="<?=$_VIEW['lot_construction_id']?>" name="id" />
           		<input type="hidden" value="<?=$_VIEW['tt_id']?>" name="tt_id" />
	            ...
	            <table width="70%" cellpadding="10" cellspacing="0" border="0" style="font-weight:normal; margin-top: 20px;" align="center">                    
                    ...
                    <tr>
                        ...
                        <td>
                        	<input id="c_actual" type="text" value="<?=$_VIEW['lot_construction_time_table_task']?>" name="timetable[str][lot_construction_time_table_task]">                      
                        </td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td>
                        	<input class="_date_" value="<?=$_VIEW['date_start']?>"  type="text" name="timetable[int][lot_construction_time_table_date_start]">                      
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input  class="_date_" value="<?=$_VIEW['date_complete']?>" type="text" name="timetable[int][lot_construction_time_table_date_complete]">                      
                        </td>
                    </tr>
                    ...
                    <tr valign="middle">
	                       <td colspan="2" align="center">                  		
                       			<div class="content_block_vpad"> 
                       			    <a href="/engineering/construction/timetable_profile/&id=<?=$_VIEW['tt_id']?>" class="link_button_inline red">Cancel</a>                      				
