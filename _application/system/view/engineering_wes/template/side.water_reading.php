<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/engineering_wes/water_reading/profile/&id={lot_wes_reading_id}">
         ...
         <li>
            <a href="/engineering_wes/water_reading/billing_statement/&id={lot_wes_reading_id}">
                <span class="icon" id="edp_project_profile"></span>
        ...
        <li>
            <a href="/engineering_wes/water_reading/remark/&id={lot_wes_reading_id}">
        ...
        <li>
            ...
            <a href="/engineering_wes/water_reading/input_reading/&id={lot_wes_reading_id}">
                <span class="icon" id="edp_edit"></span>
                <span class="label color_red {input_reading.class}">Reading</span>
            </a>
            
            <a href="/engineering_wes/water_reading/status_settings/&id={lot_wes_reading_id}">
                <span class="icon" id="edp_edit"></span>
     ...
     <li style="margin-bottom: 100px;">
            ...
            <a onclick="open_letter('water_billing')">
                <span class="icon" id="edp_edit"></span>
...
<script type="text/javascript">
	...
	{
		var myWindow = window.open("/engineering_wes/water_reading/letter/&id={lot_wes_reading_id}&letter=" + pLetter, "_blank", "width=1000, height=600, toolbar=no, scrollbars=yes, resizable=no, resizable=yes, top=50, left=50, location=no");
	}
