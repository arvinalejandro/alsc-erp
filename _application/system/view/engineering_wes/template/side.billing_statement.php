<div id="side_nav" style="width:180px;"> 
    <ul style="height:500px;"> <!--set height dynamic -->
         <li>
            <a href="/engineering_wes/billing_statement/profile/&id={}">
         ...
         <li>
            <a href="/engineering_wes/billing_statement/bill_computation/&id={}">
                <span class="icon" id="edp_project_profile"></span>
                <span class="label {bill_computation.class}">Bill Computation</span>                
            </a>            
        </li>
        
      
        <li>
            <a href="/engineering_wes/billing_statement/remark/&id={project_id}">
        ...
        <li class="">
            ...
            <a href="/engineering_wes/billing_statement/change_status/&id={}">
