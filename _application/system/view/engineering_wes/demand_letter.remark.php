...
<div id="content_body">    
    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
            ...
            <table style="margin:10px auto;" width="70%" cellpadding="5" cellspacing="0" border="0">
                <thead>
                    <tr>
                        <td>
                ...
                <tr class="selected <?=$_VIEW['module_empty']?>">
                    <td>
                        <div style="width:90%; margin:0 auto;">
                            <form name="alsc_form" method="post" action="/engineering_wes/demand_letter/submit_remark">
