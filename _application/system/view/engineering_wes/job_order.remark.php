                ...
                <tr class="selected <?=$_VIEW['module_empty']?>">
                    <td>
                        <div style="width:90%; margin:0 auto;">
                            <form name="alsc_form" method="post" action="/engineering_wes/job_order/submit_remark">
                                <textarea style="width: 100%; height: 80px;" name="textarea[remark_content]" id="remark_form"></textarea>
                                <input type="hidden" name="str[remark_key]" value="lot_wes_job_order" />
                                <input type="hidden" name="int[remark_key_id]" value="<?=$_VIEW['jo_id']?>" />                              
                                <input type="hidden" name="jo_id" value="<?=$_VIEW['jo_id']?>" />                              
                            </form>
