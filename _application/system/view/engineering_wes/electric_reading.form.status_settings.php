<div id="content_body">    
    ...
    <div id="side_listings" style="margin-left:180px;">
        ...
        <div style="overflow: auto;" id="_right_content_">
           	<form action="/engineering_wes/electric_reading/submit_status_settings/" method="post" name="alsc_form">
	            ...
	            <table width="70%" cellpadding="10" cellspacing="0" border="0" style="font-weight:normal; margin-top: 20px;" align="center">                    
                    <thead>
                        <tr>
                            <td colspan="2">Set Electric Account Reading Status</td>
                        </tr>
                    </thead>        
                    <tr>
                        <td class="color_gray">
                        ...
                        <td>
                        	<select id="c_status" name="lot_wes_reading[str][lot_wes_reading_status_id]" style="width: 100%;">
