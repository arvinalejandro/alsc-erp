<?php
class finance_billing_account
{
    
    public function __construct()
    {    	
       $this->controller_id = 'finance_billing_account';        
    }
    
    public function index($parent)
    {           
        # DB    	
       	$data['row.account']	=	mvc_model('model.client_account')->get_billing_row();        
        # VIEW
...
#----------------------- Form Pages	
   ...
   public function letter($parent)
    {      	
        ...
        $data['row.soa.invoice']	=		mvc_model('model.account_receive_invoice')->get_soa_invoice($_GET['id']);
