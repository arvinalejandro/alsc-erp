<?php
class finance_wes_water_reading
{
    
    public function __construct()
    {    	
       	$this->controller_id 			= 	'finance_wes_water_reading';
    }
   ...
   public function index($parent)
    {           
		...
		$data['row.reading']						 =	mvc_model('model.lot_wes_reading')->select_all('water','finance',$filter_cond);
        # VIEW
 ...
 //======================================FORMS
      ...
      public function payment($parent)
    {
		...
		foreach($misc as $row)
		{
			...
			$data['misc_row']					   .=	' 
						                                <tr>
						                                    <td class="bold">'.$row['option_wes_charge_name'].' :</td>
						                                   <td align="right">
        													 <span id="_vat">P '.string_amount($row['option_wes_charge_amount']).'</span>
        													</td>
						                                    <td></td>
						                                </tr>
						                                ';
        ...
        $side_nav['payment.class']					=	'bold';         	
     	...
     	# VIEW
        $parent->_view('water_reading.form.payment', $data);        
	}
	  ...
	  public function payment_status($parent)
    {
		...
		{
			 header_location("/finance_wes/water_reading/profile/&id={$id}");    
		}
        ...
        $side_nav['payment_status.class']			=	'bold';         	
     	...
     	# VIEW
        $parent->_view('water_reading.form.payment_status', $data);        
	}
  ...
  #----------------------- Form Actions
	 ...
	 public function submit_remark($parent)
	{
		...
		header_location("/finance_wes/water_reading/remark/&id={$_POST['lot_wes_reading_id']}");
	}
